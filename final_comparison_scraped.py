...
for config in test_configs:
 ...
 print(f" [OK] Berechnet: {result['avg_kwh_price']*100:.2f} ct/kWh, {result['total_cost']:.2f} € (30 Tage)")
 print()
...
print("=" * 100)
print()
print("[OK] Alle Werte sind PLZ-spezifisch und werden dynamisch gescrapt")
print("[OK] Grundpreise und Zusatz-Komponenten variieren je nach Region")
print("[OK] Börsenstrompreis wird durch unseren Prophet-Forecast ersetzt (~4-5 ct/kWh)")
print("[OK] Endkundenpreise sind realistisch und vergleichbar")
print()
