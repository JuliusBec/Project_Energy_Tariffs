...
export default {
 ...
 console.log('[OK] CSV analysis complete:', csvData)
 ...
 console.error('[WARNING] Risk analysis failed:', riskError)
 riskAnalysisData.value = null
 }
 } catch (csvError) {
 console.error('[WARNING] CSV analysis failed:', csvError)
 }
 }
 ...
 console.log('[OK] Scraper response:', scraperData)
 ...
 console.error('[WARNING] Simplified risk score failed:', riskError)
 }
 }
 ...
 console.warn('[WARNING] Could not fetch forecast data, using fallback price:', forecastError)
 }
 ...
 console.error('[ERROR] Keine Tarife von Scrapern verfügbar')
 results.value = []
 loading.value = false
 return
 }
 ...
 console.error('[ERROR] Fehler beim Laden der Tarife:', error)
 results.value = []
 } finally {
 loading.value = false
 }
