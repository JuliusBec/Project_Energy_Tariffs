...
class TadoScraper:
 ...
 logger.info("[OK] Cookies accepted")
 await asyncio.sleep(2)
 except:
 logger.info("[WARNING] No cookie banner or already accepted")
 ...
 logger.info("[OK] Price details expanded")
 except Exception as e:
 logger.warning(f"[WARNING] Could not expand details: {e}")
 ...
 markup_ct_kwh = 18.0
 logger.warning(f"[WARNING] Network fees not found, using fallback markup: {markup_ct_kwh} ct/kWh")
 ...
 logger.warning("[WARNING] Playwright loaded page but couldn't extract complete prices")
 return None

 except Exception as e:
 logger.error(f"[ERROR] Playwright scraping failed: {e}")
 return None
 ...
 logger.info("[WARNING] Playwright scraping failed, using fallback data")
