...
class TibberScraper:
 ...
 logger.info("[OK] Price breakdown opened")
 await asyncio.sleep(3)
 except Exception as e:
 logger.warning(f"[WARNING] Could not open breakdown: {str(e)[:100]}")
 ...
 logger.info(f"[OK] Playwright scraping successful!")
 ...
 logger.warning(f"[WARNING] Invalid postal code: {postal_code}, using default region")
