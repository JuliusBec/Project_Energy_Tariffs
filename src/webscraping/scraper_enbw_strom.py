...
class EnbwStromScraper:
 ...
 logger.info("[OK] Browser initialisiert")
 except Exception as e:
 logger.error(f"[ERROR] Browser-Initialisierung fehlgeschlagen: {e}")
 raise
 ...
 logger.info("[OK] Browser geschlossen")
 except Exception as e:
 logger.error(f"[WARNING] Fehler beim Schließen: {e}")
 ...
 logger.info("[OK] Cookies akzeptiert")
 except Exception as e:
 logger.warning(f"[WARNING] Cookie-Banner nicht gefunden oder bereits akzeptiert: {e}")
 ...
 if city_name:
 logger.info(f"[OK] Ort erkannt: {city_name}")
 ...
 logger.info("[OK] Tarifseite geladen, extrahiere Tarife...")
 ...
 logger.info(f"[OK] {len(tariffs)} Tarife gefunden")
 return tariffs
 else:
 logger.warning("[WARNING] Keine Tarife auf der Seite gefunden, verwende Fallback")
 ...
 logger.warning("[WARNING] Submit-Button nicht gefunden, verwende Fallback")
 return [self.get_fallback_data(postal_code, annual_consumption_kwh)]

 except Exception as e:
 logger.error(f"[ERROR] Fehler beim Scraping: {e}")
 import traceback
 traceback.print_exc()
 ...
 logger.info(f"[OK] Tarif gefunden: {tariff_name} - {grundpreis}€/Monat, {arbeitspreis}ct/kWh")
 ...
 logger.warning(f"[WARNING] Fehler beim Parsen einer Tarif-Karte: {e}")
 continue

 except Exception as e:
 logger.error(f"[ERROR] Fehler beim Extrahieren der Tarife: {e}")
 import traceback
 traceback.print_exc()
...
if __name__ == "__main__":
 ...
 print(f"\n[OK] {len(results)} Tarife gefunden:")
