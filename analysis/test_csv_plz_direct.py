...
print(f"[OK] CSV-Datei: {csv_file}")
print(f"[OK] Zeitraum: {(df['datetime'].max() - df['datetime'].min()).days} Tage")
...
print(f"[OK] CSV-Datei: {csv_file}")
print(f"[OK] Zeitraum: {(df['timestamp'].max() - df['timestamp'].min()).days} Tage")
print(f"[OK] Einträge: {len(df)}")
print(f"[OK] Jahresverbrauch (hochgerechnet): {annual_kwh:.2f} kWh")
print()
...
try:
 ...
 print(f"[OK] Grundpreis: {tibber_data['total_base_monthly']:.2f} €/Mon")
 print(f"[OK] Zusatz-Komponenten: {tibber_data['additional_price_ct']:.2f} ct/kWh")
 ...
 print(f"[OK] Durchschnitt: {tibber_result['avg_kwh_price']*100:.2f} ct/kWh")
 print(f"[OK] Monatliche Kosten: {tibber_result['total_cost']:.2f} €")
 print(f"[OK] Jährliche Kosten: {tibber_result['total_cost']*12:.2f} €")
...
try:
 ...
 print(f"[OK] Grundpreis: {enbw_data['base_price_monthly']:.2f} €/Mon")
 print(f"[OK] Zusatz-Komponenten: {enbw_data['markup_ct_kwh']:.2f} ct/kWh")
 ...
 print(f"[OK] Durchschnitt: {enbw_result['avg_kwh_price']*100:.2f} ct/kWh")
 print(f"[OK] Monatliche Kosten: {enbw_result['total_cost']:.2f} €")
 print(f"[OK] Jährliche Kosten: {enbw_result['total_cost']*12:.2f} €")
...
print(" [OK] CSV-Verbrauchsdaten (echte Smart-Meter Daten)")
print(" [OK] PLZ-spezifische Preise (dynamisch gescrapt)")
print(" [OK] Prophet-Forecast für Börsenstrompreise")
print(" [OK] Realistische Endkundenpreise")
print()
