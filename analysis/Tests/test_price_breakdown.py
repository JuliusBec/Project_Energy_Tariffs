...
def test_price_breakdown():
 ...
 if breakdown:
 print("\n[OK] Price breakdown generated successfully!\n")
 ...
 print("\n" + "="*60)
 print(f"\n[WARNING] NOTE: {breakdown['note']}")
 else:
 print("[ERROR] Failed to generate price breakdown")
 return False
