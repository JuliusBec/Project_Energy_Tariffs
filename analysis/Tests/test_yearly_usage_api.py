...
def test_yearly_usage_endpoint():
 ...
 print("\n[OK] Calculation is correct!")
 else:
 print(f"\n[WARNING] Warning: Expected {expected_annual_kwh:.2f} kWh, got {result['annual_kwh']} kWh")
 else:
 print(f"\n[ERROR] ERROR: API returned status {response.status_code}")
 print(f"Response: {response.text}")

 except requests.exceptions.ConnectionError:
 print("\n[ERROR] ERROR: Could not connect to API at http://localhost:8000")
